...
function startCountdown() {
  var duration = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 5 * 60;
  var elementId = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'timer';
  ...
  var interval = setInterval(function () {
    ...
    timerElement.textContent = "You have ".concat(minutes, ":").concat(seconds.toString().padStart(2, '0'), " minutes remaining.");
    if (timeLeft <= 0) {
